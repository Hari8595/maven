...
**Important:** drop your **real** your application code into `backend/` and `frontend/` (not sample code). The Dockerfiles wrap your code.
...
#   scp -i "king.pem" your-dump.sql ubuntu@<server>:~/app-prod/
